...
**확정 방침 (2026-09-25): 반투명 글꼴을 사용하지 않습니다.** 사용자 실기 평가로 대화 자막과 7픽셀 UI의 반투명 시험을 모두 종료했습니다. 한글 글리프 알파는 0/255만 사용하며, 후보는 흑백 픽셀 상태의 가독성으로 선정합니다. 공통 UI/로그 Galmuri7, 선택지/헤이스/우르콴 Galmuri9의 기본 패치로 복원했습니다. 아래 AA 비교와 시험 방법은 과거 실험 기록이며 현재 적용 방침이 아닙니다.
