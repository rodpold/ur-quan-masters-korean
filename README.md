...
현재 정식 에이전트 의미 검수 기록은 기본 대사 2350/3451개, 음성판 별도 번역 12/15개, 소개·엔딩 자막 74/74개입니다. 이 수치는 현재 파일과 일치하는 검수 기록의 범위이며 번역 정확성, 사용자 승인 또는 게임 전체 완료율을 뜻하지 않습니다. UI·탐사 보고·크레딧·이미지 문구와 실제 게임 화면 검증은 별도로 추적합니다.
