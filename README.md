...
공통 UI의 현재 파일 기준 의미 검수는 194/594개입니다. 저장·메뉴·수치·통신 안내를 포함하는 순서 ID 0400–0593을 검토했으며 나머지 400개는 대기 중입니다. 문맥별 번역 파일(ui-overrides.ko.json)이 바뀌면 관련 검수 기록도 다시 확인합니다.
